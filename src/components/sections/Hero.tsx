...
export function Hero() {
  return (
    <section
      ...
      className="relative isolate flex w-full min-h-screen flex-col justify-center overflow-hidden bg-background px-6 pt-32 pb-20 sm:px-10 md:px-14 lg:px-20 md:py-20 transition-colors duration-500"
    >
      ...
      <motion.div 
        ...
        // Added mt-16 on mobile to ensure it clears the fixed logo area
        className="relative z-10 mx-auto w-full max-w-6xl mt-16 sm:mt-0"
      >
